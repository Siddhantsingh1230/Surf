    ...
    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
            ...
            <div className="flex items-center">
                ...
                <label htmlFor="login-password">
                    ...
                    <input type="password"  className="w-full flex-shrink appearance-none border-gray-300 bg-white py-2 px-4 text-base text-gray-700 placeholder-gray-400 focus:outline-none" placeholder="***********" />
                    </div>
                </label>
                <label htmlFor="login-password">

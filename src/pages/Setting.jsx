            ...
            <div className="mx-4 min-h-screen max-w-screen-xl sm:mx-8 xl:mx-10 ">
                ...
                <div className="grid grid-cols-8 pt-3 pb-8 sm:grid-cols-10">
                    <div className="relative my-4 w-56 sm:hidden"  >
                        <input className="peer hidden" type="checkbox" name="select-1" id="select-1" onClick={showDropdown}/>
                        ...
                        <ul id='ul' className="max-h-0 select-none flex-col overflow-hidden rounded-b-lg shadow-md transition-all duration-300 peer-checked:max-h-56 peer-checked:py-3">
